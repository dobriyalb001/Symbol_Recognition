%CREATE TEMPLATES
%reading letters image from path 
%for num=0:9
% a[num]=imread('letters_numbers\num.bmp');
%for char=1:26
%b[char]=imread('letters_numbers\char.bmp');
...
%reading numbers image from path
...
%converting matrix to cell array 
